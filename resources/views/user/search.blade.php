...
<div class="col-md-6">
                                       ...
                                       <div class="card shadow mb-4">
                                           ...
                                           <div class="text-sm font-weight-bold text-dark text-uppercase mb-1">Name</div>
                                            ...
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">{{$user->age}}</div>
                                            <br/>
                                            <a class="btn btn-primary" href="{{route('user.viewprof',['id'=>$user->id])}}">View Profile</a>
                                           </div>
                                       </div>
                                      @endforeach  
                    </div>
