...
@endsection
                    ...
                    <div class="col-md-6">
                                ...
                                <form method="POST" action="{{ route('user.location') }}" style="margin-top: 8px;">
...
@endif
        ...
        <input type="text" name="City" placeholder="Your Current City"  value="{{$user->City}}"  class="form-control">

    </div>

    <label for="Area">Area</label>
        <input type="text" name="Area" placeholder="Your Current City"  value="{{$user->Area}}"  class="form-control">
